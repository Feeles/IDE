...
const getStyles = (props, context) => {
  const { spacing, prepareStyles } = context.muiTheme;
...
export default class Hierarchy extends PureComponent {
  ...
  render() {
    ...
    const { root, button } = getStyles(this.props, this.context);
    ...
    return (
      <div style={root}>
        ...
        <FloatingActionButton mini style={button} onClick={this.handleAdd}>
          <ContentAdd />
